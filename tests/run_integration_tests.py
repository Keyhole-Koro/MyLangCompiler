...
TESTCASES = [
    ...
    ("crossModulePayloadEnum", ["succeed/enum/cross_module_payload_enum_main.mln", "succeed/enum/cross_module_payload_enum_lib.mln"], "R1", 1156),
    ("qualifiedEnumVariant", ["succeed/enum/qualifiedEnumVariant.mln"], "R1", 17),
    ("payloadCaseHoist", ["succeed/enum/payloadCaseHoist.mln"], "R1", 179),
    ("unitResult", ["succeed/enum/unitResult.mln"], "R1", 10),
    ("exportedCallInCast", ["succeed/expr/exportedCallInCast.mln"], "R1", 16),
    ...
    ("payloadResultReturn", ["succeed/enum/payloadResultReturn.mln"], "R1", 4),
    ("hoistCaseTarget", ["succeed/enum/hoistCaseTarget.mln"], "R1", 43),
    ("nestedPayloadPattern", ["succeed/enum/nestedPayloadPattern.mln"], "R1", 13),
    ("payloadWildcardBind", ["succeed/enum/payloadWildcardBind.mln"], "R1", 10),
    ("qualifiedVariantName", ["succeed/enum/qualifiedVariantName.mln"], "R1", 0),
    ("qualifiedNumericEnum", ["succeed/enum/qualifiedNumericEnum.mln"], "R1", 201),
    ("bareNestedConstruct", ["succeed/enum/bareNestedConstruct.mln"], "R1", 0xffffffff),
    ("qualifiedFullCombo", ["succeed/enum/qualifiedFullCombo.mln"], "R1", 41997993),
    ("payloadOption", ["succeed/enum/payloadOption.mln"], "R1", 137),
    ("byvalParamAndReturn", ["succeed/struct/byval/paramAndReturn.mln"], "R1", 140),
    ("byvalReturnDirectCall", ["succeed/struct/byval/directCallReturn.mln"], "R1", 3),
    ("byvalArgumentDirectCall", ["succeed/struct/byval/directCallArgument.mln"], "R1", 3),
